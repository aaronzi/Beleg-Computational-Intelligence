...
\hypersetup{
    ...
    urlcolor=blue,
    citecolor=black,
    pdftitle={Belegarbeit Computational Intelligence},
...
\begin{titlepage}
   ...
   \begin{tabular}{l l}
      ...
      \textbf{Abgabe am:}     & 27.\xspace September 2022                               \\ 
   \end{tabular}
\end{titlepage}
\clearpage
...
\include{2_neuronale_netze}

\include{3_versuchsaufbau}

\include{4_durchführung}

\include{5_ergebnisse}
